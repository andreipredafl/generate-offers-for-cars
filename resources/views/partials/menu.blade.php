    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('offer_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.offers.index") }}" class="nav-link {{ request()->is("admin/offers") || request()->is("admin/offers/*") || request()->is("admin") ? "active" : "" }}">
                ...
                @endcan
                <div class="mt-2 mb-1" style="height: 1px; width: 100%; background-color: gray;"></div>
                @can('user_access')
                    <li class="nav-item">
                ...
                @endcan
                {{-- @can('offer_field_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.offer-fields.index") }}" class="nav-link {{ request()->is("admin/offer-fields") || request()->is("admin/offer-fields/*") ? "active" : "" }}">
