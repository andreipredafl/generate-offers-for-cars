            ...
            <form method="POST" action="{{ route('admin.offers.update', [$offer->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title"
                        id="title" value="{{ old('title', $offer->title) }}">
                    @if ($errors->has('title'))
				...
				<div class="border p-3">
					...
					@foreach ($fields as $key => $field)
						...
						@php
							$offerField = $offer->offerOfferFields()
						...
						<div class="form-group">
							...
							<input class="form-control" type="text"
								...
								value="{{ old('fields_values['.$key.']', $offerField ? $offerField->value : '') }}">
						</div>
					@endforeach
				</div>
				<br>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}"
                        name="description" id="description">{!! old('description', $offer->description) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('video_url') ? 'is-invalid' : '' }}" name="video_url"
                        id="video_url">{{ old('video_url', $offer->video_url) }}</textarea>
